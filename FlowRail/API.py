...
RTSA_url_Gangnam = "http://swopenAPI.seoul.go.kr/api/subway/476a4267646572723737724355686d/json/realtimeStationArrival/1/5/강남"

# 열차 실시간 위치 (RTP) [2호선]
# RTP API KEY = 795476586f6572723338674d467250
RTP_url_line2 = "http://swopenAPI.seoul.go.kr/api/subway/795476586f6572723338674d467250/json/realtimePosition/1/5/2호선"
...
print(RTP_get_info['realtimePositionList'][1]['subwayNm'])